...
class BacktestTests(unittest.TestCase):
        ...
        result_df = pd.DataFrame(
            {
                ...
                "predicted_signal": ["BUY", "BUY", "HOLD", "HOLD", "BUY", "BUY"],
                "buy_probability": [0.90, 0.80, 0.40, 0.40, 0.95, 0.85],
        ...
        result_df = pd.DataFrame(
            {
                ...
                "symbol": ["AAA", "BBB", "CCC"],
                "predicted_signal": ["BUY", "BUY", "BUY"],
                "buy_probability": [0.90, 0.80, 0.70],
        ...
        result_df = pd.DataFrame(
            {
                ...
                "predicted_signal": ["BUY", "BUY", "BUY", "BUY"],
                "buy_probability": [0.90, 0.80, 0.95, 0.70],
    ...
    def test_compute_top_k_backtest_can_skip_days_below_prediction_threshold(self):
        result_df = pd.DataFrame(
            {
                ...
                "symbol": ["AAA", "BBB", "AAA", "BBB"],
                "predicted_signal": ["BUY", "BUY", "BUY", "HOLD"],
                "buy_probability": [0.40, 0.35, 0.80, 0.20],
        ...
        self.assertAlmostEqual(0.45, metrics["Min_Buy_Probability"])
    ...
    def test_run_backtest_sweep_returns_one_row_per_configuration(self):
        result_df = pd.DataFrame(
            {
                "trading_date": ["2024-01-01", "2024-01-01", "2024-01-01"],
                "symbol": ["AAA", "BBB", "CCC"],
                "predicted_signal": ["BUY", "BUY", "HOLD"],
                "buy_probability": [0.90, 0.80, 0.30],
        ...
        sweep_df = run_backtest_sweep(
            ...
            min_buy_probability_values=[0.0],
            transaction_cost_rate=0.001,
            slippage_rate=0.001,
        )
        ...
        self.assertIn("Min_Buy_Probability", sweep_df.columns)
