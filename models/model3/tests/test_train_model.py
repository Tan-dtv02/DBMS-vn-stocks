...
class TrainModelTests(unittest.TestCase):
    def test_train_xgboost_model_uses_validation_set_for_early_stopping(self):
        ...
        with patch("src.train_model.XGBClassifier") as classifier_cls:
            model = classifier_cls.return_value
        ...
        self.assertEqual(10, classifier_cls.call_args.kwargs["early_stopping_rounds"])
