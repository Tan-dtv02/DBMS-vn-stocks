...
class PreprocessingTests(unittest.TestCase):
    ...
    def test_preprocess_targets_close_after_symbol_horizon_sessions(self):
        ...
        self.assertEqual(2, aaa_rows.iloc[0]["target_signal_label"])
        self.assertEqual("BUY", aaa_rows.iloc[0]["target_signal"])
    ...
    def test_preprocess_creates_sell_hold_buy_labels_from_future_return(self):
        df = pd.DataFrame(
            {
                "trading_date": [
                    "2024-01-01",
                ...
                "open": [100.0, 98.0, 100.0, 100.5],
                "close": [100.0, 98.0, 100.0, 100.5],
            }
        )
        ...
        self.assertEqual(["SELL", "HOLD"], result_df["target_signal"].tolist())
        self.assertEqual([0, 1], result_df["target_signal_label"].tolist())
